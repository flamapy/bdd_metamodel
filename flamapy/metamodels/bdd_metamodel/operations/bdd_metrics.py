...
class BDDMetrics(Metrics):
    ...
    def calculate_metamodel_metrics(self, model: VariabilityModel) -> list[dict[str, Any]]:
        ...
        self._fip = bdd_operations.BDDFeatureInclusionProbability().execute(self.model).get_result()
    ...
    def pure_optional_features(self) -> dict[str, Any]:
        ...
        _pure_optional_features = [feat for feat, prob in self._fip.items() if prob == 0.5] # noqa: PLR2004
        return self.construct_result(
            name=name,
            doc=self.pure_optional_features.__doc__,
            result=_pure_optional_features,
            size=len(_pure_optional_features),
            ratio=self.get_ratio(_pure_optional_features, self._features, 2),
        )
    ...
    def total_variability(self) -> dict[str, Any]:
        ...
        return self.construct_result(
            name=name, doc=self.total_variability.__doc__, result=_total_variability
        )
    ...
    def partial_variability(self) -> dict[str, Any]:
        ...
        return self.construct_result(
            name=name, doc=self.partial_variability.__doc__, result=_partial_variability
        )
    ...
    def homogeneity(self) -> dict[str, Any]:
        ...
        return self.construct_result(name=name, doc=self.homogeneity.__doc__, result=_homogeneity)
    ...
    def configurations(self) -> dict[str, Any]:
        ...
        _configurations = [
            feature for config in _configurations for feature in config.get_selected_elements()
        ]
        return self.construct_result(
            name=name,
    ...
    def configurations_number(self) -> dict[str, Any]:
        ...
        return self.construct_result(
            name=name, doc=self.configurations_number.__doc__, result=_configurations_number
        )
    ...
    def product_distribution(self) -> dict[str, Any]:
        ...
        return self.construct_result(name=name, doc=self.product_distribution.__doc__, result=_dist)
    ...
    def descriptive_statistics(self) -> dict[str, Any]:
        ...
        return self.construct_result(
            name=name, doc=self.descriptive_statistics.__doc__, result=_desc_stats
        )
    ...
    def feature_inclusion_probabilities(self) -> dict[str, Any]:
        ...
        _prob = self._fip
        return self.construct_result(
            name=name, doc=self.feature_inclusion_probabilities.__doc__, result=_prob
        )
