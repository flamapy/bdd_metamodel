...
class Variability(Operation):
    ...
    It is defined as the ratio between the number of its valid products and the number of the 
    potential products it could have, i.e., 2^n-1 where n is the number of features under 
    consideration. 
